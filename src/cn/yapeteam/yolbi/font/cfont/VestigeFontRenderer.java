...
public class VestigeFontRenderer extends CFont implements AbstractFontRenderer {
    ...
    public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
        drawString(text, x - getStringWidth(text) / 2 + 0.5, y + 0.5, color, true);
        return drawString(text, x - getStringWidth(text) / 2, y, color);
    }
