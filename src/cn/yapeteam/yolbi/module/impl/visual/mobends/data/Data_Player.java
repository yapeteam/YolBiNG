package cn.yapeteam.yolbi.module.impl.visual.mobends.data;
...
import cn.yapeteam.yolbi.module.impl.visual.mobends.client.renderer.SwordTrail;
				...
				if(this.currentAttack == 0){
					...
					if(this.ticksAfterPunch < 15.0f){
						if(this.currentAttack == 1) this.currentAttack = 2;
							...
							this.currentAttack = (this.getEntity().isRiding()) ? 1 : 3; //use for rideing
						}
