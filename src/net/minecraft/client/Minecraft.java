...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.fontRendererObj = new FontRenderer(new Font(null, Font.PLAIN, 18), 18, true);
        ...
        this.standardGalacticFontRenderer = new FontRenderer(new Font(null, Font.PLAIN, 18), 18, true);
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (int k2 = 0; k2 < list.size(); ++k2) {
                ...
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", j + i - 50 - this.fontRendererObj.getStringWidth(s1), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", j + i - this.fontRendererObj.getStringWidth(s1), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
            }
        }
    }
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                if (this.playerController.isNotCreative() && !DelayRemover.getInstance().isEnabled()) {
