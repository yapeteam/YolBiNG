...
public class GuiScreenBook extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.field_175386_A == null) {
                ...
                int k1 = (int) Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size());
    ...
    public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
        if (this.field_175386_A != null) {
            ...
            if (i >= 0 && j >= 0) {
                int k = (int) Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size());

                if (i <= 116 && j < this.mc.fontRendererObj.FONT_HEIGHT * k + k) {
                    int l = (int) (j / this.mc.fontRendererObj.FONT_HEIGHT);
