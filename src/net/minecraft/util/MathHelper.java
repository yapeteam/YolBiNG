...
public class MathHelper {
    ...
    private static final float radFull = (PI * 2F);
    ...
    public static float sin(float radians) {
        return /*fastMath ? SIN_TABLE_FAST[(int)(radians * 651.8986F) & 4095] : SIN_TABLE[(int)(radians * 10430.378F) & 65535]*/BF_table[(int) (radians * 2607.5945f) & 0x3FFF];
    }
    ...
    public static float cos(float value) {
        return /*fastMath ? SIN_TABLE_FAST[(int)((value + ((float)Math.PI / 2F)) * 651.8986F) & 4095] : SIN_TABLE[(int)(value * 10430.378F + 16384.0F) & 65535]*/BF_table[(int) ((value + 1.5707964f) * 2607.5945f) & 0x3FFF];
    }
    ...
    static {
        ...
        for (int j = 0; j < 4096; ++j) {
            SIN_TABLE_FAST[j] = (float) Math.sin((j + 0.5) / 4096.0F * (Math.PI * 2F));
        }

        for (int l = 0; l < 360; l += 90) {
            SIN_TABLE_FAST[(int) ((float) l * 11.377778F) & 4095] = (float) Math.sin(l * 0.017453292F);
        }
