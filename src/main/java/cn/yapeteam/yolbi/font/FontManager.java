...
public class FontManager {
    ...
    public FontManager() {
        ...
        PingFangBold12 = new FontRenderer(getFontFromTTF("PingFang_Bold", 12, Font.PLAIN), true);
        PingFangBold16 = new FontRenderer(getFontFromTTF("PingFang_Bold", 16, Font.PLAIN), true);
