...
public class GuiStats extends GuiScreen implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, lanSearchStates[(int) (Minecraft.getSystemTime() / 150L % (long) lanSearchStates.length)], this.width / 2, (int) (this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2), 16777215);
        } else {
    ...
    abstract class Stats extends GuiSlot {
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                ...
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, p_148209_2_ - (int) GuiStats.this.fontRendererObj.getStringWidth(s), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            } else {
                String s1 = "-";
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_148209_2_ - (int) GuiStats.this.fontRendererObj.getStringWidth(s1), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
        }
    ...
    class StatsGeneral extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, p_180791_2_ + 2 + 213 - (int) GuiStats.this.fontRendererObj.getStringWidth(s), p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsMobsList extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, (int) (GuiStats.this.fontRendererObj.FONT_HEIGHT * 4));
            this.setShowSelectionBox(false);
        ...
        protected int getContentHeight() {
            return (int) (this.getSize() * GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, (int) (p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT), i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, (int) (p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2), j == 0 ? 6316128 : 9474192);
        }
    }
}
